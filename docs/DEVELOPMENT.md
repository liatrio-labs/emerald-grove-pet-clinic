...
auto-fix any formatting violations before committing — the pre-commit hook also runs
this automatically. Installing the spring-javaformat IDE plugin (Eclipse/IntelliJ/VS Code)
formats on save to the same rules.
